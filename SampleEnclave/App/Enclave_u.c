...
sgx_status_t ecall_AuditLoggingEnc_sample(sgx_enclave_id_t eid, sgx_status_t* retval, char* input, size_t length)
{
	sgx_status_t status;
...
sgx_status_t ecall_AuditLoggingDec_sample(sgx_enclave_id_t eid, sgx_status_t* retval, char* input, size_t length)
{
	sgx_status_t status;
