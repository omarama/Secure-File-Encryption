...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_return_file, (char* file, int outputLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_return_plain, (char* file, int outputLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_key, (char* file, int keyLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_return_key, (char* file, int keyLength));
long int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_timestamp, ());
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_file, (char* text, int textLength, const char* path, int pathLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_binary, (char* text, int textLength, const char* path, int pathLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_file, (char* text, int textLength, const char* path, int pathLength));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_binary, (char* text, int textLength, const char* path, int pathLength));
