...
static sgx_status_t SGX_CDECL Enclave_ocall_return_file(void* pms)
{
	ms_ocall_return_file_t* ms = SGX_CAST(ms_ocall_return_file_t*, pms);
	ocall_return_file(ms->ms_file, ms->ms_outputLength);

	return SGX_SUCCESS;
}

static sgx_status_t SGX_CDECL Enclave_ocall_return_plain(void* pms)
{
	ms_ocall_return_plain_t* ms = SGX_CAST(ms_ocall_return_plain_t*, pms);
	ocall_return_plain(ms->ms_file, ms->ms_outputLength);

	return SGX_SUCCESS;
}

static sgx_status_t SGX_CDECL Enclave_ocall_get_key(void* pms)
{
	ms_ocall_get_key_t* ms = SGX_CAST(ms_ocall_get_key_t*, pms);
	ocall_get_key(ms->ms_file, ms->ms_keyLength);

	return SGX_SUCCESS;
}

static sgx_status_t SGX_CDECL Enclave_ocall_return_key(void* pms)
{
	ms_ocall_return_key_t* ms = SGX_CAST(ms_ocall_return_key_t*, pms);
	ocall_return_key(ms->ms_file, ms->ms_keyLength);
...
static sgx_status_t SGX_CDECL Enclave_ocall_get_file(void* pms)
{
	ms_ocall_get_file_t* ms = SGX_CAST(ms_ocall_get_file_t*, pms);
	ocall_get_file(ms->ms_text, ms->ms_textLength, (const char*)ms->ms_path, ms->ms_pathLength);
...
static sgx_status_t SGX_CDECL Enclave_ocall_get_binary(void* pms)
{
	...
	ocall_get_binary(ms->ms_text, ms->ms_textLength, (const char*)ms->ms_path, ms->ms_pathLength);
...
static sgx_status_t SGX_CDECL Enclave_ocall_write_file(void* pms)
{
	...
	ocall_write_file(ms->ms_text, ms->ms_textLength, (const char*)ms->ms_path, ms->ms_pathLength);
...
static sgx_status_t SGX_CDECL Enclave_ocall_write_binary(void* pms)
{
	...
	ocall_write_binary(ms->ms_text, ms->ms_textLength, (const char*)ms->ms_path, ms->ms_pathLength);
...
static const struct {
	...
	22,
	{
		...
		(void*)(uintptr_t)Enclave_ocall_return_file,
		(void*)(uintptr_t)Enclave_ocall_return_plain,
		(void*)(uintptr_t)Enclave_ocall_get_key,
		(void*)(uintptr_t)Enclave_ocall_return_key,
		(void*)(uintptr_t)Enclave_ocall_get_timestamp,
		(void*)(uintptr_t)Enclave_ocall_get_file,
		(void*)(uintptr_t)Enclave_ocall_get_binary,
		(void*)(uintptr_t)Enclave_ocall_write_file,
...
sgx_status_t ecall_AuditLoggingEnc_sample(sgx_enclave_id_t eid, sgx_status_t* retval, char* input, size_t length, char* fileName, int lengthFileName)
{
	sgx_status_t status;
...
sgx_status_t ecall_AuditLoggingDec_sample(sgx_enclave_id_t eid, sgx_status_t* retval, char* input, size_t length, char* fileName, int lengthFileName)
{
	sgx_status_t status;
